...
import dtm.dependencymanager.utils.prototypes.StopWatchLap;
...
public class DefaultStopWatch implements StopWatch{
    ...
    public StopWatchLap lap(String tag) {
        ...
        try {
            ...
            if (!laps.isEmpty()) {
                lastLapEndTime = laps.get(laps.size() - 1).getLapTime();
            }
    ...
    private static class StopWatchLapImpl implements StopWatchLap {
        private final long startTime;
        private final long lapTime;
        private final long lapTimeDuration;
        private final long lapStartTime;
        private final String tag;

        public StopWatchLapImpl(long startTime, long lapTime, long lapTimeDuration, long lapStartTime, String tag) {
        ...
        @Override
        public long getLapTimeDuration() { return lapTimeDuration; }
        ...
        @Override
        public long getTotalTime() {
            return getLapTime() - getStartTime();
        }
